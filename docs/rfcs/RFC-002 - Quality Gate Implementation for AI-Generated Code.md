# RFC-002: Quality Gate Implementation for AI-Generated Code
...
build: $(VENV)
	...
	$(PYTHON) -m PyInstaller b3-selic-pre.spec
...
do_not_mutate = [
    ...
    ".*/*",
    "build/*",
    "src/b3_selic_pre/presentation/gui/*",
    "src/b3_selic_pre/icons/*",
]
...
tkinter/matplotlib GUI layer (`src/b3_selic_pre/presentation/gui/*`) and the icons
package (`src/b3_selic_pre/icons/*`), which are not exercised by automated tests

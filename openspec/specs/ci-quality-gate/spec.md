...
Definir o workflow de CI do projeto como um quality gate reutilizável, capaz de validar lint, testes, complexidade, duplicação, cobertura, segurança e mutation check antes de releases.

...
Allow users to visualize how the SELIC Pré interest rate curve has moved over time by superimposing multiple detailed rate lines (DU252 × TAXA) with gradient coloring, one per historical date.

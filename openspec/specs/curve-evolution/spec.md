...
Allow users to visualize how the SELIC Pré interest rate curve has moved over time by superimposing multiple historical curves and showing arrow indicators for rate changes at key maturities.

...
Allow users to copy the raw data behind the current chart view (raw or consolidated) as CSV to the system clipboard, for use in spreadsheets and external analysis tools.

# Evolução Resumo Executivo

## Purpose
Calculate curve evolution indicators (ΔCurto, ΔLongo, ΔReal, ΔSlope, regime Bear/Bull Steepening/Flattening, intensity, ΔMonetary Policy, ΔTerm Premium, General Direction) and generate automatic summary text. TBD.

...
Garantir que mutantes sobreviventes identificados em `mutants/src/**/*.meta` sejam tratados de forma sistemática: mortos por testes dedicados quando matáveis, pulados e documentados quando equivalentes, com análise organizada por módulo e sem degradar os invariantes de qualidade (lint limpo, suíte completa verde, cobertura >= 85%).

...
Automatizar o build e a publicação de executáveis do `b3-selic-pre` para Windows, Linux e macOS via PyInstaller em um workflow GitHub Actions, eliminando a necessidade de o usuário instalar Python e dependências manualmente.
...
- **THEN** o asset `b3-selic-pre.desktop` é incluído entre os arquivos do release para Linux
